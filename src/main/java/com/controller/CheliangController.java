    ...
    */
    ...
    public R save(@RequestBody CheliangEntity cheliang, HttpServletRequest request){
        ...
        Wrapper<CheliangEntity> queryWrapper = new EntityWrapper<CheliangEntity>()
            ...
            .eq("cheliang_chepai", cheliang.getCheliangChepai())
            .eq("cheliang_yanse", cheliang.getCheliangYanse())
            .eq("cheliang_pinpai", cheliang.getCheliangPinpai())
            .eq("cheliang_chezuo", cheliang.getCheliangChezuo())
            ;
...
//                            cheliangEntity.setYonghuId(Integer.valueOf(data.get(0)));   //车辆 要改的
...
//                            cheliangEntity.setCheliangChepai(data.get(0));                    //车牌号 要改的
//                            cheliangEntity.setCheliangYanse(data.get(0));                    //车辆颜色 要改的
//                            cheliangEntity.setCheliangPinpai(data.get(0));                    //品牌 要改的
//                            cheliangEntity.setCheliangChezuo(data.get(0));                    //车座 要改的
