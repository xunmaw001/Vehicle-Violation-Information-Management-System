...
public class CheliangWeizhangView extends CheliangWeizhangEntity implements Serializable {
	...
	* 车辆违章类型的值
	*/
	@ColumnInfo(comment="车辆违章类型的字典表值",type="varchar(200)")
	private String cheliangWeizhangValue;
	/**
	* 违章状态的值
	*/
	@ColumnInfo(comment="违章状态的字典表值",type="varchar(200)")
	private String cheliangWeizhangZhuangtaiValue;
	/**
	* 申诉状态的值
	*/
	@ColumnInfo(comment="申诉状态的字典表值",type="varchar(200)")
	private String cheliangWeizhangYesnoValue;
	...
	* 获取： 违章状态的值
	*/
	public String getCheliangWeizhangZhuangtaiValue() {
		return cheliangWeizhangZhuangtaiValue;
	}
	/**
	* 设置： 违章状态的值
	*/
	public void setCheliangWeizhangZhuangtaiValue(String cheliangWeizhangZhuangtaiValue) {
		this.cheliangWeizhangZhuangtaiValue = cheliangWeizhangZhuangtaiValue;
	}
	//当前表的
	/**
	* 获取： 申诉状态的值
	*/
	public String getCheliangWeizhangYesnoValue() {
		return cheliangWeizhangYesnoValue;
	}
	/**
	* 设置： 申诉状态的值
	*/
	public void setCheliangWeizhangYesnoValue(String cheliangWeizhangYesnoValue) {
		this.cheliangWeizhangYesnoValue = cheliangWeizhangYesnoValue;
	}
	...
	public String toString() {
		return "CheliangWeizhangView{" +
			", cheliangWeizhangValue=" + cheliangWeizhangValue +
			", cheliangWeizhangZhuangtaiValue=" + cheliangWeizhangZhuangtaiValue +
			", cheliangWeizhangYesnoValue=" + cheliangWeizhangYesnoValue +
