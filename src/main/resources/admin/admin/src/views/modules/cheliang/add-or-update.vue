                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.cheliangPhoto" label="车辆照片" prop="cheliangPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.cheliangPhoto?$base.url+ruleForm.cheliangPhoto:''"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="品牌" prop="cheliangPinpai">
                       <el-input v-model="ruleForm.cheliangPinpai"
                                 placeholder="品牌" clearable  :readonly="ro.cheliangPinpai"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="车座" prop="cheliangChezuo">
                       <el-input v-model="ruleForm.cheliangChezuo"
                                 placeholder="车座" clearable  :readonly="ro.cheliangChezuo"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.cheliangContent"  label="车辆备注" prop="cheliangContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.cheliangContent" label="车辆备注" prop="cheliangContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   cheliangChezuo: [
                              { required: true, message: '车座不能为空', trigger: 'blur' },
                          ],
                   cheliangContent: [
                              { required: true, message: '车辆备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.cheliangContent = _this.ruleForm.cheliangContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.cheliangContent = this.ruleForm.cheliangContent.replaceAll(this.$base.url,"");
                        this.$http({
