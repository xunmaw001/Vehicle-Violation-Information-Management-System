...
var centerMenu = [
    ...
    ,{
        name: '车辆',
        url: '../cheliang/list.html'
    }
    ,{
        name: '车辆扣分',
        url: '../cheliangKoufen/list.html'
    }
    ,{
        name: '车辆违章',
        url: '../cheliangWeizhang/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/cheliangweizhang/admin/dist/index.html#/login";
